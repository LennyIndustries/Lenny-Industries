data : extend({
	{
		...
		"angels-light-attack", "angels-heavy-attack", "angels-light-defense", "angels-heavy-defense", "angels-construction", "angels-movement", "angels-energy", "angels-repair", -- Angel's angelscomponents
		"armor"}, -- Vanilla
},
})
